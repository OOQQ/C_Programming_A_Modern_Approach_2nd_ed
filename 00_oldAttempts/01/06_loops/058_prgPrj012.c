 ...
 * chapt06, pag124, prog058, prgPrj012.c
 * -------------------------------------
 * modify prog057 so that the program continues adding terms until the current
 * term becomes less than e, where e is a small floating-point number entered by
 * the user
 */
