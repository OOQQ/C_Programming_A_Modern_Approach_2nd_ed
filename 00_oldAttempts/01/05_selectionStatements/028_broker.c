 ...
 * chapt05, pag081, prog028, broker.c
 * -------------------------------------
 * our next program asks the user to enter the amount of the trade, then
 * displays the amount of the commision following this table:
 *
