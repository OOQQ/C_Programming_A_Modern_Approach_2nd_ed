 ...
 * chapt10, pag239, prog117, prgPrj002.c
 * -------------------------------------
 * modify poker.c program by moving the num_in_rank and num_in_suit arrays into
 * main(), which will pass them as arguments to read_cards and analyze_hand
 */
