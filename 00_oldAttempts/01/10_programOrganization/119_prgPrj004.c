 ...
 * chapt10, pag239, prog119, prgPrj004.c
 * -------------------------------------
 * modify poker.c program to recognize a royal flush, (ace, king, queen, jack,
 * ten of the same suit), a royal flush ranks higher than any other hand
 */
